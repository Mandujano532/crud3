                            ...
                            <div class="col-xxl">
                                <div class="card mb-4">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="mb-0">Agregar Pelicula</h5>
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="basic-default-name" name="titulo" placeholder="Crepusculo" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" id="basic-default-phone" name="stock" class="form-control phone-mask" placeholder="5" aria-label="5" aria-describedby="basic-default-phone" />
                                                </div>
                                            </div>
