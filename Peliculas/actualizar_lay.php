                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="basic-default-name" name="titulo" name="titulo"  value="<?= $row['titulo']?> " />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" id="basic-default-phone" name="stock" class="form-control phone-mask" placeholder="5" aria-label="5" aria-describedby="basic-default-phone" value="<?= $row['stock']?>"/>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-sm-7">
                                            ...
                                            <button type="button" class="btn btn-danger" onclick="window.location.href='index-peliculas.php'">Cancelar</button>
                                        </div>
                                    </div>
                                    </form>
                                </div>
