                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            <?php while ($row = mysqli_fetch_array($query)) : ?>
                                                <tr>
                                                    ...
                                                    <th><?= $row['nombre'] ?></th>
                                                    <th><?= $row['apellido'] ?></th>
                                                    <th><a href="actualizar_productor.php?id=<?= $row['id'] ?>" class="btn btn-success">Editar</a></th>
                                                    <th><a href="eliminar_productor.php?id=<?= $row['id'] ?>" class="btn btn-danger">Eliminar</a></th>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
                                    </table>
