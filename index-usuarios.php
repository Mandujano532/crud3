                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            <?php while ($row = mysqli_fetch_array($query)) : ?>
                                                <tr>
                                                    ...
                                                    <th><?= $row['direccion'] ?></th>
                                                    <th><?= $row['telefono'] ?></th>
                                                    <th><a href="actualizar_usuarios.php?id=<?= $row['id'] ?>" class="btn btn-success">Editar</a></th>
                                                    <th><a href="eliminar_usuarios.php?id=<?= $row['id'] ?>" class="btn btn-danger">Eliminar</a></th>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
                                </div>
