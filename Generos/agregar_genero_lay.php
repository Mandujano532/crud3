                            ...
                            <div class="col-xxl">
                                <div class="card mb-4">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="mb-0">Agregar Genero</h5>
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="basic-default-name" name="nombres" placeholder="Acción" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-2 col-form-label" for="basic-default-message">Descripcion</label>
                                                <div class="col-sm-10">
                                                    <textarea id="basic-default-message" name="descripcion" class="form-control" placeholder="Películas llenas de emocionantes escenas de acción, peleas, persecuciones y explosiones." aria-label="Hi, Do you have a moment to talk Joe?" aria-describedby="basic-icon-default-message2"></textarea>
                                                </div>
